    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item mt-3">
           <h6 class="ps-4 ms-2 text-uppercase text-ms font-weight-bolder opacity-6"> <i class="ni ni-tv-2 text-primary"></i> 게시판 관리 </h6>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link " href="../pages/dashboard.html">
            ...
            <span class="nav-link-text ms-1 text-sm">게시판 생성</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="../pages/dashboard.html">
            ...
            <span class="nav-link-text ms-1 text-sm">상세 페이지 관리</span>
          </a>
        </li>
