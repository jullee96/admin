...
<body class="g-sidenav-show bg-gray-100">
  <input type="hidden" id="pageTitle" value="게시판 관리">
  <input type="hidden" id="pageSubTitle" value="게시판 리스트">
                    ...
                    <thead class="thead-light">
                      <tr>
                        ...
                        <th data-sortable="" style="width: 16.3848%;">
                          <a href="#" class="dataTable-sorter">게시판 아이디</a>
                        </th>
                        <th data-sortable="" style="width: 16.2429%;">
                          <a href="#" class="dataTable-sorter">게시판 이름</a>
                        </th>
                        <th data-sortable="" style="width: 19.5766%;">
                          <a href="#" class="dataTable-sorter">게시판 권한</a>
                        </th>
                        <th data-sortable="" style="width: 22.3429%;">
                          <a href="#" class="dataTable-sorter">사용 여부</a>
                        </th>
                        <th data-sortable="" style="width: 10.8523%;">
                          <a href="#" class="dataTable-sorter">생성일</a>
                        </th>
                      </tr>
                    </thead>
                    <tbody>
